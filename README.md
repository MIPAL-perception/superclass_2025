## SuperClass-based Object Detection

## Installation and setup
- This repositiory is a modified version from code base MMdetection.
- Install the MMCV library and also `pip install -r requirements.txt`.
- Download and extract Pascal VOC 2007 to `./datasets/VOC2007/`
- Package `mmdetection` must installed from this local folder by running `python setyp.py build develop`, not from the online installation!
- Then, run the script:

```bash
python tools/train.py configs/faster_rcnn/faster_rcnn_r101_fpn_2x_voc.py
```
...
|:-------:|:----:|:--------------:|:----------------:|:-----:|
|  4-SC   | 2025 |      70.6      |       70.5       |[log.txt](work_dirs/log.txt)   |



## MMDetection Package Information
